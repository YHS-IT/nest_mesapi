...
export class SvcCnc {
  ...
  @OneToMany(() => MachinetoolBase, (machinetoolBase) => machinetoolBase.m)
  machinetoolBases: MachinetoolBase[];

  @OneToMany(
    () => ProcessBeCompleted,
    (processBeCompleted) => processBeCompleted.m
  )
  processBeCompleteds: ProcessBeCompleted[];

  @OneToMany(() => ProcessReport, (processReport) => processReport.mkey2)
  ...
  @OneToMany(() => SvcCncStatus, (svcCncStatus) => svcCncStatus.m)
  svcCncStatuses: SvcCncStatus[];

  @OneToMany(() => SvcCncStatusMemo, (svcCncStatusMemo) => svcCncStatusMemo.m)
