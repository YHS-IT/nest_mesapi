...
@Index("ent", ["ent"], {})
@Index("mid", ["mid"], {})
@Entity("svc_cnc_status_memo", { schema: "data" })
export class SvcCncStatusMemo {
  ...
  @ManyToOne(
    () => SvcEnterprise,
    (svcEnterprise) => svcEnterprise.svcCncStatusMemos,
    { onDelete: "NO ACTION", onUpdate: "NO ACTION" }
  )
  @JoinColumn([{ name: "ent", referencedColumnName: "id" }])
  ent2: SvcEnterprise;

  @ManyToOne(() => SvcCnc, (svcCnc) => svcCnc.svcCncStatusMemos, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
